SolModel<-function(VecPar,Yinitial,Period,dt)
{ 
  ...
  {
    GridTimes<-seq(Period[s],Period[s+1],dt)
    if((s+1)%%2==0)
    {
      Soltemp<-ode(Yinitial,GridTimes,Model_la,VecPar[1:7])
      dm<-dim(Soltemp)[1]
      ...
      C1_0<-yini_temp[12]
      C2_0<-yini_temp[13]
      Yinitial<-c(S11=S11_0,I11=I11_0,R11=R11_0,S21=S21_0,I21=I21_0,R21=R21_0,Vs1=Vs1_0,Vi1=Vi1_0,
                  S22=S22_0,I22=I22_0,R22=R22_0,S12=S12_0,I12=I12_0,R12=R12_0,Vs2=Vs2_0,Vi2=Vi2_0,
                  C1=C1_0,C2=C2_0)
      OutSol[[s]]<-Soltemp[1:(dm-1),]
      s<-s+1
    }
    else
    {
      Soltemp<-ode(Yinitial,GridTimes,Model_ha,VecPar)
      dm<-dim(Soltemp)[1]
      yini_temp<-as.numeric(Soltemp[dm,])
      ...
      C1_0<-yini_temp[18]
      C2_0<-yini_temp[19]
      Yinitial<-c(S1=S1_0,I1=I1_0,R1=R1_0,Vs1=Vs1_0,Vi1=Vi1_0,
                  S2=S2_0,I2=I2_0,R2=R2_0,Vs2=Vs2_0,Vi2=Vi2_0,
                  C1=C1_0,C2=C2_0)
      if(Period[s+1]==Period[length(Period)])
      {
        dm<-dm+1
      }
      OutSol[[s]]<-cbind(time=Soltemp[1:(dm-1),1],
